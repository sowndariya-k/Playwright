...
Error: locator.click: Error: strict mode violation: getByText('Paris') resolved to 2 elements:
    ...
    2) <label for="0a2c18cd-fa1b-4c6a-8aa0-7c9261483879">Paris</label> aka locator('[id="j_idt87:multiple_panel"]').getByText('Paris')
  ...
  - generic [ref=e2]:
    - generic [ref=e3]:
      - link [ref=e4] [cursor=pointer]:
        - /url: /dashboard.xhtml;jsessionid=node0t5tg2ansvomg5jmyxlqecvly19711062.node0
      - text: 
