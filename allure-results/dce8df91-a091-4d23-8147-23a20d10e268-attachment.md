...
- Location: tests\logintestdemo.test.ts:2:1
      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]:
            ...
            - textbox [ref=e12]: sowndariya
          - generic [ref=e13]:
            - generic [ref=e14]: "Password:"
            - textbox [ref=e15]: Sow@911!
        - generic [ref=e17]:
...
```ts
  ...
  11 |     await page.fill("//input[@id='loginusername']", "sowndariya"),
  12 |     await page.fill("//input[@id='loginpassword']" , "Sow@911!"),
  13 |     await page.click("//button[text()='Log in']")  
  14 |     
  15 |     await page.waitForTimeout(5000);
  16 | 
  17 |     const page1=await context.newPage();
> 18 |     page1.goto("https//www.demoblaze.com/cart.html");
     |           ^ Error: page.goto: Protocol error (Page.navigate): Cannot navigate to invalid URL
