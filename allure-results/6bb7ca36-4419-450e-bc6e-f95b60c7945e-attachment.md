...
Call log:
  ...
  - waiting for getByRole('button', { name: 'I am going to change!' })
    9 × locator resolved to <button type="submit" role="button" id="j_idt87:j_idt99" aria-disabled="false" name="j_idt87:j_idt99" onclick="PrimeFaces.ab({s:"j_idt87:j_idt99",f:"j_idt87"});return false;" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only mr-6 mb-6">…</button>
...
```yaml
- link:
  - /url: /dashboard.xhtml;jsessionid=node0vvc5y86r4x3a3y1yiafinmdb19710068.node0
- link "":
  - /url: "#"
- link:
  - /url: "#"
