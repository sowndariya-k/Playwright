...
Error: locator.click: Error: strict mode violation: getByText('Paris') resolved to 2 elements:
    ...
    2) <label for="b9ea8612-0376-40ff-b8d2-b270a5ceb73b">Paris</label> aka locator('[id="j_idt87:multiple_panel"]').getByText('Paris')
  ...
  - generic [ref=e2]:
    - generic [ref=e3]:
      - link [ref=e4] [cursor=pointer]:
        - /url: /dashboard.xhtml;jsessionid=node0a0c01i2f38a31y0tlze9eul2419711296.node0
      - text: 
