...
- Name: Timeout\checkbox.test.ts >> Favorite Languages
- Location: tests\Timeout\checkbox.test.ts:19:1

# Error details

```
Error: locator.click: Error: strict mode violation: getByText('Java') resolved to 2 elements:
    1) <label for="j_idt87:basic:0">Java</label> aka getByText('Java', { exact: true })
    2) <label for="j_idt87:basic:2">Javascript</label> aka getByText('Javascript')

Call log:
  - waiting for getByText('Java')
  ...
  - generic [ref=e2]:
    - generic [ref=e3]:
      - link [ref=e4] [cursor=pointer]:
        - /url: /dashboard.xhtml;jsessionid=node0oz9eod9jv6mmyonbmxts8qsk19711299.node0
      - text: 
...
```ts
  ...
  21 | 
> 22 |     await page.getByText("Java").click();
     |                                  ^ Error: locator.click: Error: strict mode violation: getByText('Java') resolved to 2 elements:
  23 |     await page.getByText("Python").click();
  24 | });
  25 | 
