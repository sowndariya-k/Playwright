...
Locator: getByText('Dialog')
Expected: visible
Error: strict mode violation: getByText('Dialog') resolved to 8 elements:
    1) <h5> Alert (Simple Dialog)</h5> aka getByRole('heading', { name: 'Alert (Simple Dialog)', exact: true })
    2) <h5> Alert (Confirm Dialog)</h5> aka getByRole('heading', { name: 'Alert (Confirm Dialog)' })
    3) <h5>Sweet Alert (Simple Dialog)</h5> aka getByRole('heading', { name: 'Sweet Alert (Simple Dialog)' })
    4) <span class="ui-dialog-title" id="j_idt88:j_idt96_title">Dialog</span> aka getByText('Dialog', { exact: true })
    5) <p>↵                                You have clicked…</p> aka getByText('You have clicked and open a')
    6) <h5>Sweet Modal Dialog</h5> aka getByRole('heading', { name: 'Sweet Modal Dialog' })
    7) <span class="ui-dialog-title" id="j_idt88:j_idt101_title">Modal Dialog (Sweet Alert)</span> aka getByText('Modal Dialog (Sweet Alert)')
    8) <h5> Alert (Prompt Dialog)</h5> aka getByRole('heading', { name: 'Alert (Prompt Dialog)' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Dialog')
  ...
  - generic [ref=e2]:
    - generic [ref=e3]:
      - link [ref=e4] [cursor=pointer]:
        - /url: /dashboard.xhtml;jsessionid=node019rbqcqnwaze1rjr2k3zszfx619711752.node0
      - text: 
