...
- Location: tests\PracticeActions\checkbox.test.ts:54:1
...
Error: locator.click: Error: strict mode violation: getByText('Paris') resolved to 2 elements:
    ...
    2) <label for="e034fec0-f04c-41aa-bc19-31e9f7c877c2">Paris</label> aka locator('[id="j_idt87:multiple_panel"]').getByText('Paris')
  ...
  - generic [ref=e2]:
    - generic [ref=e3]:
      - link [ref=e4] [cursor=pointer]:
        - /url: /dashboard.xhtml;jsessionid=node0bnxryz42tdwc1mmgpflzqruyc19727470.node0
      - text: 
