...
Error: locator.click: Error: strict mode violation: getByText('Paris') resolved to 2 elements:
    ...
    2) <label for="980f1228-03a3-466d-93a2-953b8b095684">Paris</label> aka locator('[id="j_idt87:multiple_panel"]').getByText('Paris')
  ...
  - generic [ref=e2]:
    - generic [ref=e3]:
      - link [ref=e4] [cursor=pointer]:
        - /url: /dashboard.xhtml;jsessionid=node09kc483s5muml3m7rda525ab919710522.node0
      - text: 
