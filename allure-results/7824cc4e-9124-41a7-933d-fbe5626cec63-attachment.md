...
```yaml
- link:
  - /url: /dashboard.xhtml;jsessionid=node01rvln3ykbpy641p9py51wgknog19715341.node0
- link "":
  - /url: "#"
- link:
  - /url: "#"
...
```ts
  ...
  9  | 
  10 | 
  11 |     await chrome.click();
  12 | 
  13 | 
  14 |     await expect(
  15 |         page.locator("//input[@value='Chrome']").first()
> 16 |     ).toBeChecked();
     |       ^ Error: expect(locator).toBeChecked() failed
  17 | 
  18 | 
  19 |     console.log("Chrome selected");
  20 | 
  21 | });
```