  ...
  - generic [ref=e2]:
    - generic [ref=e3]:
      - link [ref=e4] [cursor=pointer]:
        - /url: /dashboard.xhtml;jsessionid=node015243nmnhy102wje171xgmh3819715413.node0
      - text: 
...
```ts
  ...
  4  |     await page.goto("https://leafground.com/radio.xhtml");
  5  |     const chrome = page.locator("//input[@value='Chrome']").first();
> 6  |     await chrome.check();
     |                  ^ Error: locator.check: Test timeout of 30000ms exceeded.
  7  |     await expect(chrome).toBeChecked();
  8  |     console.log("Chrome radio selected");
  9  | 
  10 | });
```